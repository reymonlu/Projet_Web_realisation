...
--
-- INSERT INTO membre(nom,prenom,pseudo,dateNaissance,adresseMail,numeroTel,motDePasse,avatar)
-- VALUES ('CHEMIN','Ludivine','Yarps','05/06/1994','sdfs@sdfsdf','066831945','test','URL');
--
-- INSERT INTO membre(nom,prenom,pseudo,dateNaissance,adresseMail,numeroTel,motDePasse,avatar)
-- VALUES ('Tonton','Phil','master','09/12/1994','qsd@aaaaa','0668316514','test','URL');
--
--
...
-- VALUES (1,'un petit trajet',15,5,3,'2018-12-05',38000,69000);
--
--
-- INSERT INTO TRAJET(conducteur,description,prix,nombrePassagerMax,estimation,dateDepart,villeDepart,villeArrivee)
-- VALUES (2,'un petit trajet',15,5,3,'2018-12-05',38000,69000);
--
